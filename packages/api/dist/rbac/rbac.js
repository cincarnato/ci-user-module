...
class RBAC {
  constructor(rolesConfig, debug = false) {
    ...
    if (rolesConfig !== undefined) {
      this.roles = rolesConfig.reduce((accumulator, item) => {
  ...
  middleware({
    ...
    if (typeof userId === 'undefined' || typeof permissionId === 'undefined' || typeof error === 'undefined' || typeof success === 'undefined') {
      error();
